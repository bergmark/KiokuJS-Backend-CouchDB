    ...
    continued : {
        ...
        methods : {
            ...
            __createView : function (designDoc, viewName, map, reduce) {
                ...
                views[viewName] = { map : map, reduce : reduce }

                this.__createViews(designDoc, views).now()
            },
            ...
            __createViews : function (designDoc, args) {
                ...
                for (var viewName in args) if (args.hasOwnProperty(viewName)) {

                    var arg = args[viewName]
